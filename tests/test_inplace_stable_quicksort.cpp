...
auto sweep = utest::test("inplace_stable_quicksort size sweep", "[inplace_stable_quicksort]", [] {
...
auto random =
    utest::test("inplace_stable_quicksort random tests", "[inplace_stable_quicksort]", [] {
