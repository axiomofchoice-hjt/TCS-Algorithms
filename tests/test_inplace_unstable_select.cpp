...
auto sweep = utest::test("inplace_unstable_select size sweep", "[inplace_unstable_select]", [] {
...
auto random = utest::test("inplace_unstable_select random tests", "[inplace_unstable_select]", [] {
